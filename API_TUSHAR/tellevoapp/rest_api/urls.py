...
from rest_api.views import productos_por_marca, register, user_detail,registrar_compra_aprobada
from .views import register, login, registrar_compra_aprobada, reset_password, user_detail

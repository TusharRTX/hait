...
from .views import aprobar_pedido, aprobar_pedido_bodeguero, get_detalles_con_estado, get_estado_pedido, getPedidos, getPedidosAprobados, guardar_pedido_final, marcar_como_enviado, producto_detalle, productos_disponibles, rechazar_pedido, register, login, registrar_compra_aprobada, reset_password, update_estado_pedido, user_detail
